  ...
  useEffect(() => {
    ...
    if (user?.isOnboarded) {
      setOnboardingData({
        ...
        commonSymptoms: [], // Note: symptoms data not stored in user model
        severity: "",
        exerciseFrequency: "",
        stressLevel: "",
        sleepQuality: "",
    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              <div className="h-16 w-16 rounded-full bg-linear-to-br from-pink-400 to-purple-500 flex items-center justify-center mx-auto mb-4 shadow-lg">
      ...
      case 2:
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              <div className="h-16 w-16 rounded-full bg-linear-to-br from-purple-400 to-pink-500 flex items-center justify-center mx-auto mb-4 shadow-lg">
      ...
      <div className="min-h-screen bg-linear-to-br from-pink-50 via-purple-50 to-pink-50">
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto">
                    ...
                    <div className="flex items-center">
                      <div
                        className={`relative z-10 w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg transition-all duration-300 ${
                          currentStep >= step
                            ? "bg-linear-to-br from-pink-500 to-purple-600 text-white shadow-lg scale-110"
              ...
              <CardContent className="p-8 md:p-10">
                ...
                <div className="flex justify-between mt-10 pt-6 border-t border-gray-200">
                  <Button
                    ...
                    className="border-2 border-gray-300 hover:border-pink-400 hover:bg-pink-50 text-gray-700 hover:text-pink-600 font-semibold px-6 py-6 rounded-xl transition-all disabled:opacity-50"
                  >
                  ...
                  {currentStep === totalSteps ? (
                    <Button
                      ...
                      className="bg-linear-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all font-bold px-8 py-6 rounded-xl border-0 disabled:opacity-50"
                    >
                      {isSaving
                        ? "Menyimpan..."
                        : user?.isOnboarded
            ...
            {/* Info Card */}
            <div className="mt-8 bg-linear-to-r from-blue-50 to-indigo-50 border-0 shadow-lg rounded-2xl p-6">
              <div className="flex items-start space-x-4">
                <div className="h-10 w-10 rounded-full bg-linear-to-br from-blue-400 to-indigo-500 flex items-center justify-center shrink-0 shadow-md">
